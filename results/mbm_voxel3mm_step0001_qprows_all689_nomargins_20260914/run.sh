...
#
# Rerun of mbm_voxel3mm_step0001_qprows_20260910 over all 689 VAMP problems, with
...
OUT=results/mbm_voxel3mm_step0001_qprows_all689_nomargins_20260914
...
head -1 "$OUT/shard0.csv" >"$OUT/voxel3mm_step0001_qprows_all689_nomargins.csv"
for i in $(seq 0 $((SHARDS - 1))); do
    tail -n +2 "$OUT/shard$i.csv" >>"$OUT/voxel3mm_step0001_qprows_all689_nomargins.csv"
done
echo "rows: $(tail -n +2 "$OUT/voxel3mm_step0001_qprows_all689_nomargins.csv" | wc -l)"
