#pragma once
// FROZEN REFERENCE COPY of the pre-optimization HoldTimeCertificate.h, kept only so
// demo_HoldTimeBench can prove the optimized path returns the same numbers.
// Do not edit: its whole value is that it does not change.
